...
all: $(VOFILES) $(CMOFILES) $(if ifeq '$(HASNATDYNLINK)' 'true',$(CMXSFILES)) Maple.vo\
...
Maple.vo: Maple.v fake_maple/fake_maple
...
install-doc:
	install -d $(DSTROOT)$(COQDOCINSTALL)/MapleMode/html
	for i in html/*; do \
